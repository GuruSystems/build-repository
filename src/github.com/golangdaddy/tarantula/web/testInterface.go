...
func NewTestInterface(path string) RequestInterface {
...
func (ti *TestInterface) Param(s string) interface{} { return 0 }
func (ti *TestInterface) Params() map[string]interface{} { return ti.params }
func (ti *TestInterface) SetParam(s string, i interface{}) { ti.params[s] = i }
func (ti *TestInterface) SetParams(m map[string]interface{}) { ti.params = m }

func (ti *TestInterface) BodyParam(s string) interface{} { return 0 }
func (ti *TestInterface) BodyParams() map[string]interface{} { return ti.bodyParams }
func (ti *TestInterface) SetBodyParam(s string, i interface{}) { ti.bodyParams[s] = i }
func (ti *TestInterface) SetBodyParams(m map[string]interface{}) { ti.bodyParams = m }

func (ti *TestInterface) SetHeader(s, ss string) { ti.headers[s] = ss }
func (ti *TestInterface) GetHeader(s string) string { return ti.headers[s] }
